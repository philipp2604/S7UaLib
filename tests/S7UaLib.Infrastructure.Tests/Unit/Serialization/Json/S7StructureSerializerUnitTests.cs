...
namespace S7UaLib.Infrastructure.Tests.Unit.Serialization.Json;
...
public class S7StructureSerializerTests
{
    ...
    [Fact]
    public void Options_HandlesPolymorphism_ForIUaNodeCorrectly()
    {
        // Arrange
        var originalList = new List<IUaNode>
        {
        ...
        var deserializedList = JsonSerializer.Deserialize<List<IUaNode>>(json, options);
    ...
    public void Options_UsesCustomConverters_DuringSerialization()
    {
        ...
        var variable = new S7Variable
        {
            ...
            NodeId = new Opc.Ua.NodeId("MyNode", 3).ToString(),
