...
internal static class Program
{
    ...
    public static async Task Main()
    {
        ...
        // Initialize services
        _service = new S7Service(_appConfig, null, loggerFactory);
        ...
        try
        {
            ...
            else
            {
                ...
                //Variable mapping:
                //Important: Needs to be adjusted to specific system, just an example!
                await _service.UpdateVariableTypeAsync("DataBlocksGlobal.Datablock.TestString", S7DataType.STRING);
