...
public class S7LTimeConverterUnitTests
{
    ...
    public S7LTimeConverterUnitTests()
    {
        _mockLogger = new Mock<ILogger>();
    }

    private S7LTimeConverter CreateSut()
    {
        return new S7LTimeConverter(_mockLogger.Object);
    }
    ...
    public void ConvertFromOpc_WhenValueIsNotLong_ReturnsNullAndLogsError()
    {
        ...
        _mockLogger.Verify(
            log => log.Log(
                LogLevel.Error,
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, _) => v.ToString()!.Contains("but expected 'System.Int64'")),
                null,
