...
internal class S7DataStore : IS7DataStore
{
    ...
    public IReadOnlyList<S7DataBlockGlobal> DataBlocksGlobal { get; private set; } = [];

    /// <inheritdoc cref="IS7DataStore.DataBlocksInstance"/>
    public IReadOnlyList<S7DataBlockInstance> DataBlocksInstance { get; private set; } = [];

    /// <inheritdoc cref="IS7DataStore.Inputs"/>
    public S7Inputs? Inputs { get; private set; }

    /// ´<inheritdoc cref="IS7DataStore.Outputs"/>
    public S7Outputs? Outputs { get; private set; }

    /// <inheritdoc cref="IS7DataStore.Memory"/>
    public S7Memory? Memory { get; private set; }

    /// <inheritdoc cref="IS7DataStore.Timers"/>
    public S7Timers? Timers { get; private set; }

    /// <inheritdoc cref="IS7DataStore.Counters"/>
    public S7Counters? Counters { get; private set; }

    /// <inheritdoc cref="IS7DataStore.SetStructure(IReadOnlyList{S7DataBlockGlobal}, IReadOnlyList{S7DataBlockInstance}, S7Inputs?, S7Outputs?, S7Memory?, S7Timers?, S7Counters?)"/>
    public void SetStructure(
        IReadOnlyList<S7DataBlockGlobal> globalDbs,
        IReadOnlyList<S7DataBlockInstance> instDbs,
        S7Inputs? inputs,
        S7Outputs? outputs,
        S7Memory? memory,
        S7Timers? timers,
